...
Дата: 2026-09-07. Статус: план уточнено за результатами рев’ю; зміни в pipeline ще не реалізовані.
...
Початковий стан: локальні файлові/export тести вже проходили на Mac, але inference не запускався. Поточний engine жорстко використовує CUDA, bootstrap призначений для Windows; у перевіреному системному Python 3.14.5 arm64 PyTorch відсутній. CPU-тести не підтверджують сумісності моделей із MPS.
