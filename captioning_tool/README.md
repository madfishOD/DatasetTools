...
Це нейтральна версія. У Python збережена перевірка графічних сексуальних відповідей; це не unrestricted-версія. Відхилена відповідь дає помилку, а не відредагований caption. Прийнятий текст моделі зберігається повністю без ручних змін, обрізання речень чи замін. Простий словниковий фільтр може помилятися; це не гарантія класифікації вмісту.
